  ...
  return (
    <>
      <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
        {/* Left side - Clerk SignIn Component */}
                ...
                appearance={{
                  elements: {
                    ...
                    socialButtonsBlockButton:
                      "bg-white hover:bg-gray-50 border-2 border-gray-200 text-gray-700 font-medium",
                    formButtonPrimary:
                      "bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300",
                    formFieldInput:
                      "bg-white/90 backdrop-blur-sm rounded-xl border-2 border-slate-200 text-slate-800 font-medium focus:border-blue-500 focus:ring-4 focus:ring-blue-100",
