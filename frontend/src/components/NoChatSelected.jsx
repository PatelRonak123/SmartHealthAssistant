        ...
        <div className="max-w-lg text-center space-y-8 relative z-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-slate-600 font-medium leading-relaxed">
              Select a conversation from the sidebar to start chatting with users or connect with our AI assistant
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-12">
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 shadow-lg border border-white/50 hover:shadow-xl transition-all duration-300 hover:scale-105">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                ...
                />
                <MessageSquare className="w-6 h-6 text-white" style={{ display: 'none' }} />
              </div>
              <h3 className="text-lg font-bold text-slate-800 mb-2">Real-time Chat</h3>
              <p className="text-sm text-slate-600">Instant messaging with users</p>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 shadow-lg border border-white/50 hover:shadow-xl transition-all duration-300 hover:scale-105">
              <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                ...
                />
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20" style={{ display: 'none' }}>
                  <path fillRule="evenodd" d="M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.123.489.804.804A1 1 0 0113 18H7a1 1 0 01-.707-1.707l.804-.804L7.22 15H5a2 2 0 01-2-2V5zm5.771 7H9a1 1 0 110 2H9.229z" clipRule="evenodd" />
                </svg>
              </div>
              <h3 className="text-lg font-bold text-slate-800 mb-2">AI Assistant</h3>
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 shadow-lg border border-white/50 hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <h3 className="text-lg font-bold text-slate-800 mb-2">Book Appointments</h3>
